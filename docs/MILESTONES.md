...
- Run the packaged forced-crash recovery probe on the native macOS and Windows quality hosts and record the exact evidence. Then audit the complete M3 gate and resolve the remaining save-status/renderer-bridge ownership with M4 in this roadmap before changing milestone status; do not claim M3 complete while an explicit deliverable remains unproven.
