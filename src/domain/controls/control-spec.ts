...
const CONTROL_DEFINITIONS: readonly ControlDefinition[] = Object.freeze([
  ...
  createDefinition({
    ...
    maximumSize: null,
    palette: createPalette('Chart: Bar', 'Common', 90),
  ...
  createDefinition({
    ...
    maximumSize: null,
    palette: createPalette('Chart: Line', 'Common', 100),
    propertiesSchema: staticVisualPropertiesSchema,
  ...
  createDefinition({
    ...
    minimumSize: createSize(72, 72),
    maximumSize: null,
    palette: createPalette('Chart: Pie', 'Common', 110),
    propertiesSchema: staticVisualPropertiesSchema,
  ...
  createDefinition({
    ...
    minimumSize: createSize(72, 28),
    maximumSize: null,
    palette: createPalette('Playback', 'Media', 120),
    propertiesSchema: staticVisualPropertiesSchema,
  ...
  createDefinition({
    ...
    maximumSize: null,
    palette: createPalette('Video Player', 'Media', 130),
    propertiesSchema: staticVisualPropertiesSchema,
  ...
  createDefinition({
    ...
    maximumSize: null,
    palette: createPalette('Volume Slider', 'Media', 140),
    propertiesSchema: staticVisualPropertiesSchema,
  ...
  createDefinition({
    ...
    maximumSize: null,
    palette: createPalette('Webcam', 'Media', 150),
    propertiesSchema: staticVisualPropertiesSchema,
