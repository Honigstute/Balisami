...
const CONTROL_DEFINITIONS: readonly ControlDefinition[] = Object.freeze([
  ...
  createDefinition({
    ...
    minimumSize: createSize(72, 28),
    maximumSize: null,
    palette: createPalette('Playback', 'Media', 90),
  ...
  createDefinition({
    ...
    maximumSize: null,
    palette: createPalette('Video Player', 'Media', 100),
    propertiesSchema: staticVisualPropertiesSchema,
  ...
  createDefinition({
    ...
    maximumSize: null,
    palette: createPalette('Volume Slider', 'Media', 110),
    propertiesSchema: staticVisualPropertiesSchema,
  ...
  createDefinition({
    ...
    maximumSize: null,
    palette: createPalette('Webcam', 'Media', 120),
    propertiesSchema: staticVisualPropertiesSchema,
